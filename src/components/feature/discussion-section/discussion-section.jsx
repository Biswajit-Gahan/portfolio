...
export default function DiscussionSection() {
    return <section className={"bg-neutral-600/10 mt-8 overflow-y-clip"}>
        <div className={"container-auto relative overflow-y-auto lg:min-h-[30rem]"}>
            <Image src={userDiscussionImage} alt={"shaik"} className={"hidden lg:block absolute right-[15%] h-[80%] w-auto bottom-0"} />
            <div className={" py-8"}>
                <div className={"flex flex-col items-center gap-3 lg:flex-row lg:gap-5"}>
                    <Image className={"w-20 lg:w-30"} src={handshakeIcon} alt={"brand logo"} />
                    <p className={"text-[clamp(1.8rem,5vw,4rem)] font-black text-center lg:text-left lg:leading-18 bg-gradient-to-r from-[#0467FC] to-[#FF3E9B] inline-block text-transparent bg-clip-text"}>Let's Discuss About Your Next Dream Project</p>
                </div>
                <div className={"mt-6 lg:absolute lg:bottom-20 lg:left-[13.9rem]"}>
