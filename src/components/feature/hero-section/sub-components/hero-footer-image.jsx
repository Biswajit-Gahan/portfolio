...
export default function HeroFooterImage() {
    ...
    return <Image ref={heroFooterImageRef} className={`absolute bottom-0 -right-10 h-full w-auto object-contain object-bottom lg:left-1/2 hide-element ${isIntersect && "animate-[slide-right_1s_0.7s_forwards]"}`}
