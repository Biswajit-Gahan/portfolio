...
export default function HeroBackgrounds() {
    ...
    return <div>
        <Image ref={heroBackgroundRef} className={`absolute top-1/2 left-1/2 -translate-y-1/2 hide-element ${isIntersect && "animate-[slide-left_1s_0.2s_forwards]"}`} src={bgStripe} alt={"background"}/>
    </div>
}